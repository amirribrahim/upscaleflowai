...
import GraphicBack from "@/assets/GraphicBack.png";
  ...
  const packages = [
    {
      ...
      name: "ENGAGE PACK ",
      price: 499,
      Description: "An essential starter kit designed for growing brands that want consistent, professional, and visually engaging social media presence.",
      features: [
        "12 Custom Static Posts (Instagram/Facebook)",
        "4 Story Templates",
        "1 Carousel Template (up to 5 slides)",
        "1 Profile Picture Design",
        "1 Cover Banner (choose one: FB, LinkedIn, or YouTube)",
        "Highlight Icon Set (up to 3)",
        "Branded Design Style (color palette + fonts setup)",
      ],
    },
    {
      id: 2,
      name: "AUTHORITY PACK ",
      Description: "A premium package crafted for ambitious brands looking to dominate their niche with high-quality visuals, strategic design elements, and full customization options.",
      price: 1799 ,
      features: [
        "20 Custom Post Designs (mix of static, carousel, and quote formats)",
        "10 Story Templates",
        "3 Carousel Templates (editable)",
        "3 Platform Covers (FB, LinkedIn, YouTube)",
        "Highlight Icon Set (up to 6)",
        "Profile Picture Optimization",
        "Editable Templates in Canva or PSD (your choice)",
        "Style guide PDF for social media usage",
        "3 Mockup Previews (phone & profile grid)",
        "3 Revision Rounds",
...
const response = await fetch(`${API_URL}/api/submit-social`, {
   method: 'POST',
...
const selectedPackage = packages.find(pkg => pkg.id === selected);
  ...
  return (
    <section className=" p-8 pt-2 lg:p-12 rounded-lg " >
