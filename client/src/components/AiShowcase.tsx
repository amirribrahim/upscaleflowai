...
const AiShowcase = ({ onDiscoverClick }) => {
    ...
    <div className="relative max-w-7xl mx-auto px-6 lg:px-2 py-24 flex flex-col lg:flex-row items-center justify-between">
        ...
        >
          {/* Headline */}
            ...
            <br />
            <span className="bg-gradient-to-r from-blue-600 via-black to-blue-500 bg-clip-text text-transparent animate-gradient-x ">Intelligence in Motion</span>
          </h1>

          {/* Subtext */}
          <p className="text-lg lg:text-xl font-medium text-black-700 leading-relaxed max-w-md mx-auto lg:mx-0">
            
            <span className="font-semibold text-blue-600">Your automation</span>,{" "}
            <span className="font-semibold italic"> is the engine that powers growth. We design smart, adaptive, and secure AI solutions tailored to your needs, creating seamless workflows that save time, enhance trust, and deliver measurable results.</span> {" "}
...
>
  ...
  <motion.img
    src={Hand}
    alt="Laptop mockup"
    className="relative z-5  w-[750px]  max-w-none drop-shadow-2xl rounded-xl"
    animate={{ y: [0, -25, 0] }}
