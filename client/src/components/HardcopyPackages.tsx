...
const packages = [
  {
    ...
    Description:
      "A tailored solution for brands that want to elevate their product presentation. We craft visually compelling packaging designs that align with your brand identity while ensuring practicality for printing and production.",
    features: [
      "2 Initial Design Concepts",
      "2 Rounds of Revisions",
      "Print-Ready Files in PDF, AI (and PNG for digital use)",
      "Mockups for presentation",
      "Custom Dieline Setup (if not provided)",
      "Consultation on Materials & Printing Options",
    ],
  },
  {
    id: 2,
    name: "PRINTABLE DESIGNS",
    Description:
      "Perfect for businesses that need professional, high-quality print materials to stand out. From flyers and brochures to posters and cards, we design print-ready visuals that engage, inform, and leave a lasting impression.",
    features: [
      "Custom Design",
      "2 Initial Concepts",
      "2 Rounds of Revisions",
      "Print-Ready Files (PDF, AI, EPS with bleed & crop marks)",
      "Web Version (if needed) for digital sharing (PDF or PNG)",
      "Consultation on Paper Types & Finishing Options",
    ],
  },
];
...
const response = await fetch(`${API_URL}/api/submit-hardcopy`, {  method: 'POST',
    method: 'POST',
...
export default HardcopyPackages;
