...
const GraphicShowCase = ({ onDiscoverClick }) => {
    ...
    <div className="relative max-w-7xl mx-auto px-6 lg:px-2 py-24 flex flex-col lg:flex-row items-center justify-between">
        ...
        >
          ...
          <h1 className="text-[50px] lg:text-[60px] font-blod italic">
            ...
            <br />
            <span className="bg-gradient-to-r from-blue-600 via-black to-blue-500 bg-clip-text text-transparent animate-gradient-x">Creativity in Motion</span>
          </h1>

          {/* Subtext */}
             <p className="text-lg lg:text-xl font-medium text-black-700 leading-relaxed max-w-md mx-auto lg:mx-0">
            
            <span className="font-semibold text-blue-600 italic ">Your visuals </span>,{" "}
            <span className="font-semibold italic"> are the bridge between your brand and your audience. We create fast, intuitive, and captivating designs crafted for impact, clarity, and consistency tailored to your brand’s goals.</span> {" "}
        ...
        {/* Right Content - Animated Shapes */}
        <div className="hidden lg:flex w-2/5 relative mt-16 lg:mt-0 justify-center h-[500px]">

        <motion.div
  className="hidden lg:flex w-2.5/5 relative mt-12 lg:mt-0 justify-center"
...
>
  ...
  />
          ...
          {/* Animated Blob */}
          <motion.div
            className="absolute w-48 h-48 bg-gradient-to-r from-blue-500 to-blue-500 rounded-full opacity-10 blur-2xl"
            animate={{ scale: [1, 1.1, 1], rotate: [0, 45, -45, 0] }}
