...
router.post('/submit-social', async (req, res) => {
  try {
    ...
    const businessEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: black; border-bottom: 2px solid black; padding-bottom: 10px;">
             🎉 New Social Package Subscription!
        </h2>
    ...
    const customerEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: black;">Thank you for your ! </h2>
