  ...
  try {
    ...
    const businessEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #3B82F6; border-bottom: 2px solid black; padding-bottom: 10px;">
        ...
        <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; border-left: 4px solid #3B82F6;">
          ...
          <ul style="margin: 0; padding-left: 20px;">
            ...
            <li>Schedule free consultation Meeting </li>
    ...
    const customerEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: black;">Thank you for reaching out! </h2>
        
        <p>Hi ${fullName},</p>
        
        <p>Thank you for your interest in our agency services! We've received your consultation request and are excited to learn more about your project.</p>
        ...
        <div style="background: #ecfdf5; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p style="margin-bottom: 0;">Feel free to reply to this email . We're here to help!</p>
        </div>
    ...
    const customerMailOptions = {
      from: process.env.SMTP_USER,
      to: email,
      subject: ` Upscaleflowai Consultation Request Received - We'll be in touch soon!`,
