  ...
  try {
    ...
    const businessEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Total Amount:</strong> <span style="color: #059669; font-size: 18px;">$${total}</span></p>
        </div>
    ...
    const customerEmailHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>Thank you for choosing us for your website project! We've received your order and are excited to help bring your vision to life.</p>
    ...
    const businessMailOptions = {
      ...
      subject: `🚀 New Order ${orderId} - ${selectedPackage.name} ($${total})`,
